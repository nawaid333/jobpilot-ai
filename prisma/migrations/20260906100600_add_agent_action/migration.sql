...
CREATE INDEX "AgentAction_applicationId_idx" ON "AgentAction"("applicationId");
CREATE INDEX "AgentAction_signalId_idx" ON "AgentAction"("signalId");
...
ALTER TABLE "AgentAction" ADD CONSTRAINT "AgentAction_signalId_fkey" FOREIGN KEY ("signalId") REFERENCES "EmailSignal"("id") ON DELETE CASCADE ON UPDATE CASCADE;
